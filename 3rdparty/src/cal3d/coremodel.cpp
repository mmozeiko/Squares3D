...
int CalCoreModel::loadCoreAnimation(std::istream& inputStream)
{
  ...
  CalCoreAnimationPtr pCoreAnimation = CalLoader::loadCoreAnimation(inputStream, m_pCoreSkeleton.get());
...
int CalCoreModel::loadCoreAnimation(std::istream& inputStream, const std::string& strAnimationName)
{
  int id = -1;
  ...
  {
    id = loadCoreAnimation(inputStream);
    if(id >= 0)
...
int CalCoreModel::loadCoreMaterial(std::istream& inputStream)
{
  // the core skeleton has to be loaded already
  if(!m_pCoreSkeleton)
  {
  ...
  CalCoreMaterialPtr pCoreMaterial = CalLoader::loadCoreMaterial(inputStream);
...
int CalCoreModel::loadCoreMaterial(std::istream& inputStream, const std::string& strMaterialName)
{
  int id = -1;
  ...
  {
    id = loadCoreMaterial(inputStream);
    if(id >= 0)
...
int CalCoreModel::loadCoreMesh(std::istream& inputStream)
{
  // the core skeleton has to be loaded already
  if(!m_pCoreSkeleton)
  {
  ...
  CalCoreMeshPtr pCoreMesh = CalLoader::loadCoreMesh(inputStream);
...
int CalCoreModel::loadCoreMesh(std::istream& inputStream, const std::string& strMeshName)
{
  int id = -1;
...
bool CalCoreModel::loadCoreSkeleton(std::istream& inputStream)
{
  // load a new core skeleton
  m_pCoreSkeleton = CalLoader::loadCoreSkeleton(inputStream);
...
bool CalCoreModel::saveCoreAnimation(std::ostream& outputStream, int coreAnimationId)
{
  ...
  if(!CalSaver::saveCoreAnimation(outputStream, m_vectorCoreAnimation[coreAnimationId].get()))
  {
    return false;
  }
...
bool CalCoreModel::saveCoreMaterial(std::ostream& outputStream, int coreMaterialId)
{
  ...
  // save the core animation
  return CalSaver::saveCoreMaterial(outputStream, m_vectorCoreMaterial[coreMaterialId].get());
}
...
bool CalCoreModel::saveCoreMesh(std::ostream& outputStream, int coreMeshId)
{
  ...
  // save the core animation
  return CalSaver::saveCoreMesh(outputStream, m_vectorCoreMesh[coreMeshId].get());
}
...
bool CalCoreModel::saveCoreSkeleton(std::ostream& outputStream)
{
  ...
  return CalSaver::saveCoreSkeleton(outputStream, m_pCoreSkeleton.get());
}

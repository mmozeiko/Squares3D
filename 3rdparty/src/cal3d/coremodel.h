...
public:
  ...
  int loadCoreAnimation(std::istream& inputStream);
  int loadCoreAnimation(std::istream& inputStream, const std::string& strAnimationName);
  int unloadCoreAnimation(const std::string& name);
  int unloadCoreAnimation(int coreAnimationId);
  bool saveCoreAnimation(std::ostream& outputStream, int coreAnimationId);
  ...
  int loadCoreMaterial(std::istream& inputStream);
  int loadCoreMaterial(std::istream& inputStream, const std::string& strMaterialName);
  int unloadCoreMaterial(const std::string& name);
  int unloadCoreMaterial(int coreMaterialId);
  bool saveCoreMaterial(std::ostream& outputStream, int coreMaterialId);
  ...
  int loadCoreMesh(std::istream& inputStream);
  int loadCoreMesh(std::istream& inputStream, const std::string& strMeshName);
  int unloadCoreMesh(const std::string& name);
  int unloadCoreMesh(int coreMeshId);
  bool saveCoreMesh(std::ostream& outputStream, int coreMeshId);
  bool addMeshName(const std::string& strMeshName, int coreMeshId);
  int getCoreMeshId(const std::string& strMeshName);

  // skeleton
  CalCoreSkeleton *getCoreSkeleton();
  bool loadCoreSkeleton(std::istream& inputStream);
  bool saveCoreSkeleton(std::ostream& outputStream);

...
#define REGISTER_TEXT_TYPE(type) m_texts.insert(make_pair(STR(type), TEXT_##type))
	...
	REGISTER_TEXT_TYPE(PLAYER_KICKED);
	REGISTER_TEXT_TYPE(SERVER_FULL);
	REGISTER_TEXT_TYPE(SERVER_DISCONNECT);
	REGISTER_TEXT_TYPE(PLAYER_NAME_TAKEN);
	REGISTER_TEXT_TYPE(INFORMATION);
    REGISTER_TEXT_TYPE(SERVER_VERSION);
    REGISTER_TEXT_TYPE(NET_CREATE_FAILED);

    REGISTER_TEXT_TYPE(RLY_QUIT);
    REGISTER_TEXT_TYPE(NETWORK_ESC_MESSAGE);
    REGISTER_TEXT_TYPE(SERVER_NET_PORT);
    REGISTER_TEXT_TYPE(HOST);
    REGISTER_TEXT_TYPE(LEVEL);
    REGISTER_TEXT_TYPE(LEVEL_DEFAULT),
    REGISTER_TEXT_TYPE(LEVEL_EXTRA),
